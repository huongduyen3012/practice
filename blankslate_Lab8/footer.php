<footer id="footer">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-4">
                    ...
                    <p class="footer-gioithieu">Chuyên cung cấp, sửa chữa máy tính, laptop, máy in, PC gaming và lắp đặt
                        camera. Với hơn 8 năm kinh nghiệm, chúng tôi cam kết mang đến sự hài lòng cho Quý khách.</p>
                    <ul class="footer-diachi">
                        <li><i class="fa fa-map-marker" style="margin-right: 7px;"></i> <span>960 KP. 4, P. Thới Hòa,
                                TX. Bến Cát, Bình Dương</span></li>
    ...
    <div id="copyright">
        <div class="container">
            Copyright © 2023 Vi tính Đức Thành.
        </div>
    </div>
</footer>
<script
    src="https://www.vitinhducthanh.com/wp-content/plugins/ar-contactus/res/js/jquery.maskedinput.min.js?version=2.0.1"></script>
